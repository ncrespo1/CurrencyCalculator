package com.example.ncrespo.currencycalculator;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("Destroy", "App has been destroyed");
    }
    ...
    public void convert_curr(View view) {
        ...
        Toast.makeText(getApplicationContext(), "This is a toast - That is Long", Toast.LENGTH_SHORT).show();
